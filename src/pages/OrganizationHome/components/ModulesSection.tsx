  ...
  const modulos = React.useMemo(
    () => [
      ...
      },
      {
        ...
        icon: (
          <GroupIcon fontSize="small" sx={{ color: "rgb(137, 78, 238)" }} />
        ),
      ...
      },
      {
        ...
        icon: (
          <ListAltIcon fontSize="small" sx={{ color: "rgb(137, 78, 238)" }} />
        ),
      ...
      },
      {
        ...
        icon: (
          <GavelIcon fontSize="small" sx={{ color: "rgb(137, 78, 238)" }} />
        ),
      ...
      },
      {
        ...
        icon: (
          <BarChartIcon fontSize="small" sx={{ color: "rgb(137, 78, 238)" }} />
        ),
        path: "/relatorios",
      },
      {
        ...
        icon: (
          <SettingsIcon fontSize="small" sx={{ color: "rgb(137, 78, 238)" }} />
        ),
            ...
            return (
              <Box
                ...
                sx={{
                  ...
                  "&:hover": {
                    background:
                      "linear-gradient(135deg, rgba(191,219,254,0.6), rgba(216,180,254,0.6))",
                  },
                }}
              >
                <Box
                ...
                >
                  ...
                  >
                      ...
                      >
                        <Box
                          sx={{
                            ...
                            color: "#2563eb",
                            background:
                              "linear-gradient(135deg,rgb(252, 239, 255),rgb(248, 238, 255))",
                    ...
                    >
                      <Button
                        onClick={() =>
                          isDisponivel && onOpenModulo(modulo.path)
                        }
                        size="small"
                        variant="contained"
