...
const SupportSection = ({ onNavigateHistoria, onOpenChat }: Props) => {
  return (
    <Box
      component='section'
        ...
        >
          <Box
            sx={{
              ...
              boxShadow: 1,
              height: '100%',
              background: 'linear-gradient(135deg,rgb(248, 239, 255),rgb(248, 238, 255) 60%, #faf5ff)'
            }}
          >
            <Box
              sx={{
          ...
          >
            <Box
              sx={{
                ...
                pt: 3,
                pb: 2.5,
                background: 'linear-gradient(135deg,rgb(247, 238, 255), rgb(248, 238, 255) 60%, #ffffff)'
              }}
            >
