    ...
    >
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.25, flexWrap: 'wrap' }}>
          {isEditMode && (
            <DragIndicatorIcon
              sx={{ color: '#94a3b8', fontSize: 24, cursor: 'grab', '&:active': { cursor: 'grabbing' } }}
            />
          )}
          <Box
            sx={{
              ...
              height: 36,
              borderRadius: '50%',
              bgcolor: stage.isOptional ? '#9333EA' : '#1877F2',
              color: 'white',
              display: 'flex',
              alignItems: 'center',
              ...
              fontWeight: 700,
              fontSize: '0.9375rem',
              boxShadow: stage.isOptional ? '0 2px 4px rgba(147, 51, 234, 0.3)' : '0 2px 4px rgba(24, 119, 242, 0.3)',
              flexShrink: 0
            }}
          >
          ...
          {stage.isOptional && (
            <Chip
              label='OPCIONAL'
              size='small'
              sx={{ bgcolor: '#9333EA', color: 'white', fontWeight: 800, fontSize: '0.7rem', height: 22 }}
            />
          )}
        </Box>
      </Box>
          ...
          {stage.requiresApproval && (
            <Chip
              ...
              sx={{
                ...
                fontSize: '0.75rem',
                height: 24,
                '& .MuiChip-icon': { ml: 0.5, fontSize: 16, color: '#92400E' }
              }}
            />
          )}
          {stage.canRepeat && (
            <Chip
              label='Pode repetir'
              size='small'
              sx={{ bgcolor: '#F0F2F5', color: '#616161', fontWeight: 800, fontSize: '0.75rem', height: 24 }}
            />
          )}
          {stage.businessDaysDuration !== undefined && stage.businessDaysDuration > 0 && (
            <Chip
              icon={<CalendarIcon sx={{ fontSize: 16, color: '#7C3AED' }} />}
              label={`${stage.businessDaysDuration} ${stage.businessDaysDuration === 1 ? 'dia útil' : 'dias úteis'}`}
              size='small'
              sx={{
                bgcolor: '#F5F3FF',
                color: '#7C3AED',
      ...
      <Dialog
        ...
        PaperProps={{
          sx: {
            ...
            display: 'flex',
            flexDirection: 'column',
            maxHeight: previewFullscreen ? '100vh' : '90vh'
          }
        }}
      >
        <Box
      ...
      >
        <DialogContent sx={{ p: 0 }}>
          <Box sx={{ px: 3, py: 2.5, borderBottom: '1px solid #E4E6EB' }}>
            ...
            >
              Confirme se a etapa foi completamente finalizada
            </Typography>
          </Box>
