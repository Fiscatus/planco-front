...
import { BLUE_500, INK_100, INK_500, INK_700, INK_900, CONTAINER_SX } from '../constants';
    ...
    <Box sx={CONTAINER_SX}>
      ...
      >
        ...
        <Box sx={{ gridColumn: { xs: 'span 2', md: 'auto' } }}>
          ...
          <Box component='p' sx={{ fontSize: '14px', color: INK_500, lineHeight: 1.6, mt: '16px', mb: '20px', maxWidth: 300 }}>
        ...
        {FOOTER_COLS.map(col => (
          <Box key={col.title}>
            <Box component='h5' sx={{ fontSize: '12px', color: INK_500, fontWeight: 500, letterSpacing: '0.08em', textTransform: 'uppercase', m: 0, mb: '16px' }}>
              {col.title}
            </Box>
