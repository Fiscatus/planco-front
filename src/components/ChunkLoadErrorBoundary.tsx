...
const ChunkErrorFallback = ({ error }: { error: Error }) => {
  ...
  useEffect(() => {
    if (chunkError && retryCount < maxRetries) {
      console.log(`Chunk loading error detected, refreshing page... (attempt ${retryCount + 1}/${maxRetries})`);
    ...
    return (
      ...
      >
        ...
        <Typography
          ...
          textAlign='center'
        >
          The application has been updated. Refreshing to load the latest version.
    ...
    return (
      ...
      >
        ...
        <Typography
          ...
          textAlign='center'
        >
          Unable to load the latest version after {maxRetries} attempts. Please refresh manually.
        </Typography>
        <Button
          variant='contained'
