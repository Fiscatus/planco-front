      ...
      <DialogContent>
        <Box sx={{ pb: 2 }}>
          ...
          <Typography variant="body2" sx={{ mb: 2 }}>
            ...
            sobrenome, endereço de e-mail e senha quando você cria uma conta.
          </Typography>
          ...
          <Typography variant="body2" sx={{ mb: 2 }}>
            ...
            Notificaremos sobre mudanças significativas por e-mail ou através de
            nossos serviços.
          </Typography>
          ...
          <Typography variant="body2" sx={{ mb: 2 }}>
            ...
            contato conosco através dos canais disponíveis em nossa plataforma.
          </Typography>
          ...
          <Box sx={{ display: "flex", justifyContent: "flex-end", mt: 3 }}>
            <Button
              ...
              sx={{
                ...
                "&:hover": {
                  background:
                    "linear-gradient(135deg, hsl(262 83% 50%), hsl(224 71% 50%))",
                },
              }}
            >
              Fechar
